...
The standard deviation is not smaller than 10.
...
## Conclusion
Keep $H_0$ at the $\alpha$=0.01 level. There is sufficient evidence to suggest that the two departments are given different bonuses.
