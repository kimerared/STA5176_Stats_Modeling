...
```
### Hypothesis:  
- $H_0: \ \sigma \ge 10$ OR $\sigma^2 \ge 100$
- $H_1: \ \sigma < 10$ OR $\sigma^2 < 100$
...
## Conclusion
Keep $H_0$. There is not sufficient evidence to suggest that the standard deviation of math scores for 4th graders is less than 10.
...
## Conclusion
Keep H0 at the $\alpha$=0.01 level. There is sufficient evidence to suggest that the two departments have equal variance.
...
# varTest(credit$Bonus, mortgage$Bonus,
#         conf.level = 0.99,
