...
data %>% ggplot(aes(x = Population, y = Revenue)) +
  ...
  geom_text(aes(x =262, y = 440, label = "30,000 persons")) +
  geom_text(aes(x = 264, y = 400, label = "21,100 persons")) +
  geom_text(aes(x = 264, y = 380, label = "15,000 persons")) +
...
sensitivity_df %>% ggplot(aes(x = Distance, y = Revenue)) +
  ...
  labs(title = "Sensitivity Multiple Linear Regression",
       subtitle = "Predictor: Distance",
       x = "Distance",
       y = "Revenue") +
  theme_bw()
...
sensitivity_df %>% ggplot(aes(x = Population, y = Revenue)) +
  ...
  geom_text(aes(x =106, y = 296, label = "24,000 persons")) +
