...
gg_sensitivity_population <- sensitivity_df %>% ggplot(aes(x = Population, y = Revenue)) +
  ...
  geom_text(aes(x = 106, y = 290, label = "20,900 persons")) +
  geom_text(aes(x = 106, y = 280, label = "15,000 persons")) +
  labs(title = "Multiple Linear Regression",
       subtitle = "Predictor: Population",
       x = "Population",
       y = "Revenue") +
...
#### Graphs Comparison
```{r}
ggarrange(gg_sensitivity_distance, gg_distance, ncol = 2, nrow = 1)
ggarrange(gg_sensitivity_population, gg_population, ncol = 2, nrow = 1)
```
