...
gg_population_min <- data %>% ggplot(aes(x = Population, y = Revenue)) +
...
# Population ggplot 
gg_population <- gg_population_min +
...
# Basic Distance plot
gg_distance_min <- data %>% ggplot(aes(x = Distance, y = Revenue)) +
  geom_point(size=3, color = "darkgray") + 
...
# Basic Distance sensitivity plot
gg_sensitivity_min <- sensitivity_df %>% ggplot(aes(x = Distance, y = Revenue)) +
  geom_point(size=3, color = "darkgray") + 
  geom_line(aes(y = d55), color = "orange") +
...
gg_sensitivity_distance <- gg_sensitivity_min +
...
distance_comparison <- gg_sensitivity_min +
  xlim(c(120, 365))+
  ylim(c(200, 450))
```
...
# Basic Population sensitivity plot
gg_sensitivity_population_min <- sensitivity_df %>% ggplot(aes(x = Population, y = Revenue)) +
  geom_point(size=3, color = "darkgray") + 
  geom_line(aes(y = p150), color = "orange") +
...
gg_sensitivity_population <- gg_sensitivity_population_min +
  geom_text(aes(x =106, y = 298, label = "24,000 persons")) +
  geom_text(aes(x = 106, y = 286, label = "20,900 persons")) +
  geom_text(aes(x = 106, y = 265, label = "15,000 persons")) +
  xlim(c(50, 115))

gg_sensitivity_population

population_comparison <- gg_sensitivity_population_min + 
  xlim(c(50, 275))+
  ylim(c(200, 460))
...
```{r}
ggarrange(population_comparison, gg_population_min, ncol = 2, nrow = 1)
```
#### Distance Comparison
```{r}
ggarrange(distance_comparison, gg_distance_min, ncol = 2, nrow = 1)
```
