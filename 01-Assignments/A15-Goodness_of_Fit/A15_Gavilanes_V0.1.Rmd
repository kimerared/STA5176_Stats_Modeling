...
```{r, echo = TRUE}
n = sum(229, 211, 93, 35, 7, 0, 0, 1) #576
...
probabilities <- round(dpois(0:7, lambda = y_hat), digits = 4)
probabilities
...
expected_freq_group
# Goodness of Fit
chisq.test(observation_freq_group, p = expected_freq_group/n)

```
Observation   |   0       1       2       3       4       5       6       7
------------------------------------------------------------------------------
Probability
$\mu$= 0.932  | 0.3937  0.367   0.1711  0.0532  0.0124  0.0023  0.0004    0
...
-------------------------------------------------------------------
Expected      | 226.7712    211.392   98.5536   30.6432    8.6976
