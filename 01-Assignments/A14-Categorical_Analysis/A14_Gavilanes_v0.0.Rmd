...
ggplot(alcohol_count, aes(fill = alc, y = n, x = alc))+
  ...
  labs(title = "Proportion of Regular Drinkers",
       ...
       y = "Count")+
  theme_bw()+
  geom_text(label = "1,372",x = 1, y = 1000, size = 4, colour = "white")+
  geom_text(label = "1,271",x = 2, y = 1000, size = 4, colour = "white")+
  geom_text(label = "10",x = 3, y = 60, size = 4, colour = "darkgray")
