...
## Conclusion
The T-test demonstrated that there was a difference of bonuses earned for both groups. Especially for the credit department, there are some outliers towards the right tail.
...
data_long %>% 
  ...
  geom_density(alpha=0.2)+
  geom_vline(data = summary_long_htable, aes(xintercept=Avg, color=Test), linetype="dashed", size = 1.1)+
  xlim(35,110)+
...
Even though the scores have improved, the grade average is not greater than 5 points. The tutoring department should continue working on the reading comprehension program. Yet, the reading comprehension program is not ready to be integrated into its curriculum. 
