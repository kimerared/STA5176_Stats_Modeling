...
The standard deviation between both halves of the game indicates that the scores are around the mean (12.88). 
Indeed, both halves are approximately 1.04 points different from the mean. 
We can infer that the data is symmetrically distributed because there is a minor difference between the mean and median.
...
```
The mean for both algebra and chemistry are similar. 
