...
The small standard deviation between the two halves of the game  indicates that the scores are around the mean (12.88). 
Indeed, for both halves are approximately 1.04 points difference to the mean. 
Since the difference between mean and median is small, we can infer that the data is symmetrically distributed.
Even though the team has consistent scores, the first half are sligthly better than the second one. 
