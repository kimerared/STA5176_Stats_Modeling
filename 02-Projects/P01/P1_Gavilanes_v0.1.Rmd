...
The assumption of normality may not be valid; therefore, the report will use the Wilcoxon nonparametric test.
...
## Analysis
The first half has shown better scores. I can conclude that the team has more energy at the beginning of the match; therefore, they can make better throws. The UWF basketball team has to improve stamina and concentration throughout the game.
...
### NonParametric Test
The assumption of normality may not be valid; therefore, the report uses the Wilcoxon nonparametric test.
#### Wilcoxon Test
```{r}
basket_wilcox
```
...
## Assumption
The following QQ and Density plots demonstrate some discrepancies between the two halves. The data is not normally distributed.
```{r}
graph_paired_qq_plot(basketball, half_2, half_1)
basketball_density
```
