...
The assumption of normality may not be valid. The data is not normally distributed.

**f. Based on your assessment in part (e), are you going to report the *t* test or the nonparametric test?**

The report will use the Wilcoxon nonparametric test.
...
### NonParametric Test
The report uses the Wilcoxon nonparametric test.
