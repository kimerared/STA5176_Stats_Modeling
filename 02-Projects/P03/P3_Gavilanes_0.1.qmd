...
age_plot <- gg_data %>% ggplot(aes(x = age, y = charges)) +
  ...
  geom_point(data = outlier_color, color = "#FB9902", size = 3) +
  geom_line(aes(y = ch0), color = "magenta", size = 1.5) +
  geom_line(aes(y = ch2), color = "magenta", size = 1.5) +
  geom_line(aes(y = ch4), color = "magenta", size = 1.5) +
  geom_text(aes(x = 68, y = 25500, label = "4 children")) +
  geom_text(aes(x = 68, y = 19000, label = "2 children")) +
